...
<h1><a href="index.php"><i class="fas fa-tachometer-alt text-light "> Dashboard</i> </a> <small>Statistics Overview</small></h1>
...
<hr>
<h3>New Students</h3>
<table class="table table-hover table-bordered table-secondary table-responsive-xl" id="data" style="width: 100%;">
  <thead class="thead-dark">
    <tr>
      <th scope="col">SL</th>
      <th scope="col">Name</th>
      <th scope="col">PN Email</th>
    ...
    <?php 
      ...
      <tr>
        ...
        echo '<td>'.$i.'</td>
          ...
          <td>'.$result['pn_email'].'</td>
          <td>'.ucwords($result['student_address']).'</td>
